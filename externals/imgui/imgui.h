...
namespace ImGui
{
    ...
    IMGUI_API void          ProgressBarCustomColor(float fraction, const ImVec4& colorLeft = ImVec4(0,1,0,1), const ImVec4& colorBg = ImVec4(1,1,1,1), const ImVec2& size_arg = ImVec2(-1, 0), const char* overlay = NULL);
